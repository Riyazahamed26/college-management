...
firstw=Tk()
firstw.title("AL AMEEN COLLEGE OF ENGINEERING")
firstw.geometry("1600x1000+0+0")
label=Label(text="AL AMEEN COLLEGE OF ENGINEERING",font=("times new roman",35),bg="MediumOrchid2")
...
def second():
    global secondw
    secondw=Tk()
    secondw.title("AL AMEEN COLLEGE OF ENGINEERINGL")
    ...
    def distroy5():
        secondw.destroy()
        window()
    mainlabel= Label(secondw,text="AL AMEEN COLLEGE OF ENGINEERING", font=("times new roman", 35), bg="MediumOrchid2")
    mainlabel.pack(side=TOP, fill=X)
...
def distroy():
    firstw.destroy()
def login():
    if user.get()=="123" and user3.get()=="123":
        second()
        distroy()
...
def root():
    ...
    root.title("AL AMEEN COLLEGE OF ENGINEERING")
    global entry1
    global entry2
    global entry3
    global entry4
